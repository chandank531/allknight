document.addEventListener("DOMContentLoaded", () => {
  ...
  if (product) {
    ...
    document.querySelector(".product-info .description").innerText =
      product.description;
  ...
  function updateCartCount() {
    ...
    console.log('Cart item count:', itemCount); // Debug statement
    ...
    if (userIcon) {
      userIcon.innerHTML = `<i class="fas fa-user"></i> User`;
    } else {
